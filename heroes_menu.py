...
class Menu:
    ...
    def draw(self, screen):
        ...
        screen.blit(self.kn2, (self.width * 0.3, self.height * 0.5))
        # все координаты подсчитываются в процентном виде, чтобы на любом экране интерфейс выглядел одинаково
        screen.blit(self.kn1, (self.width * 0.7, self.height * 0.5))
        # шрифт для заголовка
        ...
        screen.blit(self.text, self.coors)
        ...
        pygame.draw.rect(screen, (0, 0, 0), (self.text_next1 - 5, self.text_next2 - 5, self.next.get_width() + 10,
                                                  self.next.get_height() + 10), 4)
        pygame.draw.rect(screen, (169, 169, 169),
                         (self.text_next1 - 5 + 4, self.text_next2 - 5 + 4, self.next.get_width() + 10 - 6,
                          self.next.get_height() + 10 - 6))
        screen.blit(self.next, (self.text_next1, self.text_next2))
        ...
        # вывожу на экран
        screen.blit(self.new_im, (self.coor_im_x, self.coor_im_y))
        screen.blit(name, (self.coor_n_x, self.coor_n_y))
        screen.blit(tip, (self.coor_t_x, self.coor_t_y))
        screen.blit(descr1, (self.coor_d_x1, self.coor_d_y1))
        screen.blit(descr2, (self.coor_d_x2, self.coor_d_y2))
        # обновляю экран
